...
import com.neishenme.what.galleryfinal.toolsfinal.adapter.PhotoPreviewAdapter;
import com.neishenme.what.galleryfinal.widget.GFViewPager;
...
public class PhotoPreviewActivity extends PhotoBaseActivity implements ViewPager.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( mThemeConfig == null) {
            resultFailureDelayed("请重新打开相册", true);
        } else {
