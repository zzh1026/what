package com.neishenme.what.socket;
...
import com.neishenme.what.socket.helper.HeartBeatHelper;
import com.neishenme.what.socket.helper.SocketClientAddress;
import com.neishenme.what.socket.helper.SocketClientDelegate;
import com.neishenme.what.socket.helper.SocketClientReceiveDelegate;
import com.neishenme.what.socket.helper.SocketClientSendingDelegate;
import com.neishenme.what.socket.helper.SocketConfigure;
import com.neishenme.what.socket.helper.SocketInputReader;
import com.neishenme.what.socket.helper.SocketPacket;
import com.neishenme.what.socket.helper.SocketPacketHelper;
import com.neishenme.what.socket.helper.SocketResponsePacket;
import com.neishenme.what.socket.util.CharsetUtil;
import com.neishenme.what.socket.util.ExceptionThrower;
...
//                                ALog.i("发送包头第一波数据为: " + new String(headerData));
...
//                            }
                            ...
                            if (segmentLength == SocketPacketHelper.SegmentLengthMax) {
                                ...
                                while (offset < data.length) {
                                    ...
                                    ALog.i("刷出的数据为: " + new String(data, offset, end - offset, "UTF-8"));
                                    self.getRunningSocket().getOutputStream().flush();
...
//                                ALog.i("发送包尾数据为: " + new String(tailData));
//                                self.getRunningSocket().getOutputStream().flush();
//
