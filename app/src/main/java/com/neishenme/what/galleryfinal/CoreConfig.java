...
public class CoreConfig {
    ...
    private CoreConfig(Builder builder) {
        ...
        if ( takePhotoFolder == null ) {
            takePhotoFolder = new File(Environment.getExternalStorageDirectory(), "/DCIM/" + "neishenme/");
        }
        ...
        if ( editPhotoCacheFolder == null ) {
            editPhotoCacheFolder = new File(Environment.getExternalStorageDirectory() + "/neishenme/edittemp/");
        }
