 ...
 * 活动界面适配器
 */
public class ActiveNearByAdapter extends BaseAdapter {
    private Context mContext;
    private ActiveNearByActivity mActiveNearByActivity;
    private List<ActiveListResponse.DataBean.TakemeoutBean> takemeoutAll;

    public ActiveNearByAdapter(ActiveNearByActivity mActiveNearByActivity, List<ActiveListResponse.DataBean.TakemeoutBean> takemeoutAll) {
        mContext = mActiveNearByActivity;
        this.mActiveNearByActivity = mActiveNearByActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.mItemActiveTicketSub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mActiveNearByActivity.ticketSub(position);
            }
        });
        return view;
    }
