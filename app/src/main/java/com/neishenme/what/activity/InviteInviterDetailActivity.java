 ...
 * =====================================
 * .
 * 这是一个新的 邀请详情 发布者的界面 详细解释见 @see {@link InviteJoinerDetailActivity}
 * .
 * 其作用是 :
 */
public class InviteInviterDetailActivity extends BaseActivity implements HttpLoader.ResponseListener {
    ...
    protected int initContentView() {
        return R.layout.activity_invite_new_inviter_detail;
    }
    ...
    protected void initListener() {
        ...
        ll_video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent1 = new Intent(InviteInviterDetailActivity.this, PlayVideoActivity.class);
        ...
        mInviteDetailUserLogo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityUtils.startActivityForListData(InviteInviterDetailActivity.this,
        ...
        mInviteDetailJoinPersons.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                UserDetailActivity.startUserDetailAct(InviteInviterDetailActivity.this, userId, showBtn, inviteId, newstatus);
            }
        });
            ...
            public void onClick(View v) {
                switch (startBtnState) {
                    ...
                    case START_SURE_FACE:   //确认见面
                        ...
                        ZXingGetActivity.startZXingAct(InviteInviterDetailActivity.this, inviteDetailBean);
                        break;
                }
            }
        });
        ...
        mInviteDetailTogetherMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {   //位置共享
                SharedLocationV5Activity.startSharedLocationAct(
                        InviteInviterDetailActivity.this, mInviteLatitude, mInviteLongitude,
        ...
        mInviteDetailMoreInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳转到用户详情界面
                UserDetailActivity.startUserDetailAct(InviteInviterDetailActivity.this, Integer.parseInt(NSMTypeUtils.getMyUserId()), false);
            }
        });
        ...
        mInviteDetailTalkLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(InviteInviterDetailActivity.this, ChatActivity.class)
