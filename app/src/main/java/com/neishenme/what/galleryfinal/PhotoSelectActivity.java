...
import com.neishenme.what.galleryfinal.adapter.FolderListAdapter;
import com.neishenme.what.galleryfinal.adapter.PhotoListAdapter;
import com.neishenme.what.galleryfinal.model.PhotoFolderInfo;
import com.neishenme.what.galleryfinal.model.PhotoInfo;
import com.neishenme.what.galleryfinal.permission.AfterPermissionGranted;
import com.neishenme.what.galleryfinal.permission.EasyPermissions;
...
import com.neishenme.what.galleryfinal.utils.PhotoTools;
...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( GalleryFinal.getFunctionConfig() == null || GalleryFinal.getGalleryTheme() == null) {
            resultFailureDelayed("重新打开相册", true);
        } else {
