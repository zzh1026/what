...
public class FriendsNewsAdapter extends AddHobbySelectableAdapter {
    ...
    public FriendsNewsAdapter(Context mContext, List<EMConversation> mConversationList) {
...
//        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        for (EMMessage message : item.getAllMessages()) {
            if (message.getTo().equals(myHxUserName)) {
        ...
        if (emMessageInfo != null) {
            userName = emMessageInfo.getStringAttribute(Constant.SEND_USER_NAME, "");
        }
        if (!TextUtils.isEmpty(userName)) {
            ...
            if (emMessageInfo.getFrom().equalsIgnoreCase(Constant.SEND_USER_NSM_SERVER)) {
                ...
                holder.mTvUserName.setText("好友");
            }
        }
        String stringUserLogo = null;
        if (emMessageInfo != null)
            stringUserLogo = emMessageInfo.getStringAttribute(Constant.SEND_USER_LOGO, "");
        if (!TextUtils.isEmpty(stringUserLogo)) {
            ...
            holder.mIvUserLogo.setImageResource(R.drawable.picture_moren);
        }
